...
let pairVal_to_fst = function
  | PairVal ( exp_val1 , exp_val2 ) -> exp_val1
  | _ -> failwith " Expected a pair ! "

let pairVal_to_snd = function
  | PairVal ( exp_val1 , exp_val2 ) -> exp_val2
  | _ -> failwith " Expected a pair ! "

let listVal_to_list = function
  | ListVal l1 -> l1
  | _ -> failwith "Expected a List in listVal_to_list"
...
let rec string_of_expval = function
  ...
  | _ -> "String in string_of_expval in ds.ml"
